...
from filebrowser.settings import STRICT_PIL, DIRECTORY, EXTENSIONS, SELECT_FORMATS, ADMIN_VERSIONS, ADMIN_THUMBNAIL, MAX_UPLOAD_SIZE,\
    ...
    LIST_PER_PAGE, OVERWRITE_EXISTING, DEFAULT_PERMISSIONS, MEDIA_ROOT
...
def get_disk_usage(path=MEDIA_ROOT):
    """
    Get disk usage info
    """
    # returns example:
    ...
    return { k: humanize(getattr(usage, k)) for k in usage._fields }
